# Post-training analysis — `wave1-semlex-full-v7`

**Overall test accuracy:** 5.59%  
**Macro F1:** 0.004  
**Total test clips:** 143  
...
|---|---|---|---|---|
| `deaf` | 0.00 | 0.00 | 0.00 | 7 |
| `eat` | 0.00 | 0.00 | 0.00 | 8 |
| `four` | 0.00 | 0.00 | 0.00 | 2 |
| `friend` | 0.00 | 0.00 | 0.00 | 6 |
...
|---|---|---|---|---|
| `please` vs `sorry` | 0.00 (n=4) | 0.00 (n=1) | 0/0 | 0.00% |
| `what` vs `where` | 0.00 (n=5) | 0.00 (n=17) | 0/0 | 0.00% |
| `four` vs `five` | 0.00 (n=2) | 0.00 (n=0) | 0/0 | 0.00% |
| `one` vs `two` | 0.00 (n=7) | 0.00 (n=3) | 0/0 | 0.00% |
| `two` vs `three` | 0.00 (n=3) | 0.00 (n=1) | 0/0 | 0.00% |
| `eat` vs `drink` | _not in trained set_ | | | |
| `hello` vs `goodbye` | 0.00 (n=3) | 0.00 (n=1) | 0/0 | 0.00% |
